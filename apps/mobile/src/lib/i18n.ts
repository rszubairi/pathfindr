      ...
      mobile: {
        ...
        details: {
          ...
          documents: {
            ...
            transcripts: 'Official Academic Transcripts & Certificates',
            languageCert: 'English Language Proficiency Certificate (IELTS/TOEFL)',
            recommendationLetters: 'Two Letters of Recommendation',
            personalStatement: 'Personal Statement / Statement of Purpose',
            visa: 'Student Visa Application Documents',
          },
        },
      },
    },
    ...
    translation: {
      ...
      mobile: {
        ...
        details: {
          ...
          documents: {
            passport: 'Pasport Sah (kesahan minimum 6 bulan)',
            transcripts: 'Transkrip & Sijil Akademik Rasmi',
            languageCert: 'Sijil Kecekapan Bahasa Inggeris (IELTS/TOEFL)',
            recommendationLetters: 'Dua Surat Sokongan',
            personalStatement: 'Pernyataan Peribadi / Pernyataan Tujuan',
            visa: 'Dokumen Permohonan Visa Pelajar',
          },
        },
      },
    },
    ...
    translation: {
      ...
      mobile: {
        ...
        details: {
          ...
          documents: {
            passport: '有效护照（至少6个月有效期）',
            transcripts: '官方学业成绩单及证书',
            languageCert: '英语语言能力证书（雅思/托福）',
            recommendationLetters: '两封推荐信',
            personalStatement: '个人陈述 / 目的说明',
            visa: '学生签证申请文件',
          },
        },
      },
