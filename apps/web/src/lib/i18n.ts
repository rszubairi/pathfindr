  ...
  en: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Showing scholarships matched to your interests and target countries.',
        previous: 'Previous',
        next: 'Next',
  ...
  ms: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Menunjukkan biasiswa yang sepadan dengan minat dan negara sasaran anda.',
        previous: 'Sebelumnya',
        next: 'Seterusnya',
  ...
  zh: {
    translation: {
      ...
      scholarships: {
        ...
        showResults: '显示 {{count}} 个结果',
        recommendations: '推荐',
        recommendationsHint: '显示与您的兴趣和目标国家匹配的奖学金。',
        previous: '上一页',
        next: '下一页',
        noResults: '未找到奖学金项目',
  ...
  es: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Mostrando becas que coinciden con tus intereses y países objetivo.',
        previous: 'Anterior',
        next: 'Siguiente',
  ...
  pt: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Exibindo bolsas que correspondem aos seus interesses e países-alvo.',
        previous: 'Anterior',
        next: 'Próximo',
  ...
  de: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Zeigt Stipendien, die zu Ihren Interessen und Zielländern passen.',
        previous: 'Zurück',
        next: 'Weiter',
  ...
  ja: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'あなたの興味と志望国に合った奨学金を表示しています。',
        previous: '前へ',
        next: '次へ',
  ...
  ko: {
    translation: {
      ...
      scholarships: {
        ...
        recommendations: '추천',
        recommendationsHint: '관심사 및 목표 국가에 맞는 장학금을 표시하고 있습니다.',
        previous: '이전',
        next: '다음',
  ...
  vi: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Hiển thị học bổng phù hợp với sở thích và quốc gia mục tiêu của bạn.',
        previous: 'Trang trước',
        next: 'Trang sau',
  ...
  id: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'Menampilkan beasiswa yang sesuai dengan minat dan negara tujuan Anda.',
        previous: 'Sebelumnya',
        next: 'Berikutnya',
  ...
  hi: {
    translation: {
      ...
      scholarships: {
        ...
        recommendationsHint: 'आपकी रुचियों और लक्ष्य देशों से मेल खाने वाली छात्रवृत्तियाँ दिखाई जा रही हैं।',
        previous: 'पिछला',
        next: 'अगला',
