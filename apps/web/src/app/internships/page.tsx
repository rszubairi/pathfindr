      ...
      <Container className="py-8 sm:py-12">
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              { id: 'fullTime', label: t('internships.filtersList.fullTime') },
              { id: 'partTime', label: t('internships.filtersList.partTime') },
              { id: 'remote', label: t('internships.filtersList.remote') }
            ].map((type) => (
              <label
                key={type.id}
